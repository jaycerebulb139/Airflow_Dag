...
class SCCOptimizer:
    def __init__(self, bound_strategy="min-max"):
        ...
        self.input_tag_map_object = "silver_data_layer/cgpp/Web APIs/boiler3_read_tag_map.csv"
        self.output_tag_map_object = "silver_data_layer/cgpp/Web APIs/boiler3_write_tag_map.csv"
        ...
        self.model_features = [
            'HIL_AL_UTKL_CPP_U3_BLR_03_CALC_FUEL_AIR_RATIO', # x[0]
            'HIL_AL_UTKL_CPP_U3_BLR_03_CALC_WIND_BOX_DP',    # x[1]
            'HIL_AL_UTKL_CPP_U3_BLR_03_PA_FAN_PRI_AIR_FL_TOT', # x[2]
            'HIL_AL_UTKL_CPP_U3_BLR_03_FURN_WIND_BOX_AIR_FL_TOT', # x[3]
            'HIL_AL_UTKL_CPP_U3_BLR_03_PRESS_PIPNG_MN_STM_FL_TRNSMTR_01', # x[4]
            'HIL_AL_UTKL_CPP_U3_BLR_03_ECO_FLUE_GAS_TEMP_AVG', # x[5]
            'HIL_AL_UTKL_CPP_U3_BLR_03_SUPR_HTR_MN_STM_HDR_TEMP_02', # x[6]
            'HIL_AL_UTKL_CPP_U3_BLR_03_COAL_FDR_TOT_FLW', # x[7]
            'HIL_AL_UTKL_CPP_U3_BLR_03_ESP_DUCT_INL_FLUE_GAS_TEMP_AVG', # x[8]
            'HIL_AL_UTKL_CPP_U3_BLR_03_FD_WTR_REG_STN_FL_TOT', # x[9]
            'HIL_AL_UTKL_CPP_U3_BLR_03_FD_WTR_REG_STN_TEMP', # x[10]
            'HIL_AL_UTKL_CPP_U3_BLR_03_CALC_OXY', # x[11]
            'HIL_AL_UTKL_CPP_U3_BLR_03_CALC_STM_ENTHLP', # x[12]
            'HIL_AL_UTKL_CPP_U3_BLR_03_CALC_FD_WTR_ENTHLP', # x[13]
        ]
