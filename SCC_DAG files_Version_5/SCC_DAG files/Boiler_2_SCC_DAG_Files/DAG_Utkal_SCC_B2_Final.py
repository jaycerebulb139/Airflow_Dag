...
class SCCOptimizer:
    def __init__(self, bound_strategy="min-max"):
        ...
        self.input_tag_map_object = "silver_data_layer/cgpp/Web APIs/boiler2_read_tag_map.csv"
        self.output_tag_map_object = "silver_data_layer/cgpp/Web APIs/boiler2_write_tag_map.csv"
