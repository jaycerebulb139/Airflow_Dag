...
from DAG_Utkal_BE_B3_Final import SCCOptimizer
import traceback
...
def transform_data(**kwargs):
    ...
    try:
        ...
        predictions = {
            'MILL_REJ': x_opt[optimizer.var_index['HIL_AL_UTKL_CPP_U3_BLR_03_CALC_MILL_REJCT_LOSS']],
            'BLOW_DOWN': x_opt[optimizer.var_index['HIL_AL_UTKL_CPP_U3_BLR_03_CALC_BLW_DOWN_LOSS']],
