...
class SCCOptimizer:
    def __init__(self, bound_strategy="min-max"):
        ...
        self.input_tag_map_object = "silver_data_layer/cgpp/Web APIs/SCC_boiler1_read_tag_map.csv"
        self.output_tag_map_object = "silver_data_layer/cgpp/Web APIs/SCC_boiler1_write_tag_map.csv"
