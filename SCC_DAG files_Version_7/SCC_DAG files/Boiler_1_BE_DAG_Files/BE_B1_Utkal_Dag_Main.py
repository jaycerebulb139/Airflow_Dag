...
from DAG_Utkal_BE_B1_Final import SCCOptimizer
import traceback
...
def transform_data(**kwargs):
    ...
    try:
        ...
        predictions = {
            'MILL_REJ': x_opt[optimizer.var_index['HIL_AL_UTKL_CPP_U1_BLR_01_CALC_MILL_REJCT_LOSS']],
            'BLOW_DOWN': x_opt[optimizer.var_index['HIL_AL_UTKL_CPP_U1_BLR_01_CALC_BLW_DOWN_LOSS']],
